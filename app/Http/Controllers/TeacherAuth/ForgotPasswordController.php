...
class ForgotPasswordController extends Controller
{
    ...
    */
    ...
    public function sendResetLinkEmail(){
        ...
        if($user){
            $reset_url = 'http://localhost:8000/teacher/new/password?id='.$user->id.'&curr_id='.$user->password;
            ...
            $email->addTo($email, "");
            $email->addContent(
                "text/html", $this->_emailBody($reset_url)
            );
            ...
            // Mail::to($email)->send(new ResetPassword($reset_url));
        }else{
    ...
    public function _emailBody($reset_url){
        $body = '
            <!DOCTYPE html>
            <html lang="en">
               <head>
