        ...
        <div class="admin_access_inner clearfix">
            <div class="admin_acecss_logo">
                <p>Don’t have an account ? <br> 
                    <router-link :to="`/student/signup`">Sign up here</router-link>
                </p>
            ...
            <div class="admin_acecss_form">
                ...
                <form @submit.prevent="authenticate">
                    ...
                    <router-link :to="`/student/forgot/password`">Forgot Password ?</router-link>
                </form>
            </div>
            <router-link :to="`/teacher/login`" class="s_t_l">switch to Teacher login</router-link>
    ...
    export default {
        ...
        methods: {
            authenticate: function(){
                ...
                var url = '/api/auth/student/login';
